...
```sql
ALTER TABLE lab ADD lab_size INT DEFAULT 50;
```
...
```sql
INSERT INTO lab VALUES (100, '가상현실', '2공학관', 'B203', 'comp');
INSERT INTO lab VALUES (110, '인공지능', '2공학관', 'A101', 'comp');
```
