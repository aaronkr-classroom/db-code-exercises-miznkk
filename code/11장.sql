...
where name = '홍길동';
-- planning time: 0.063ms
-- execution time: 4.796ms
...
select * from members2
where name = '홍길동';
-- planning time: 0.063ms => 1.036ms
-- execution time: 4.796ms => 0.752ms
...
from registrations r
join members m on r.member_id = m.member_id
join classes as c on r.class_id = c.class_id;
